...
*The percentage of adults in the sample who think climage change affects their community is 0.667.*
...
*Given n = 60 observations in each of our samples, I would expect to see minor-to moderate differences in the proportions.*
...
*It means that we are 95% confident that our confidence interval contains the population parameter that we are interested in (e.g., mean, median, etc.)*
...
*Yes our bootstrapping example yields a lower and upper confidence interval of 0.5 to 0.750, respectively. The true population proportion lies within that interval.* 
...
*I would expect that ~95% of the student intervals would capture the true population mean. This goes back the central limit theorem and the fact that our sampling distribution approximates a normal distribution. Due to the latter, we can evaluate our sampling points (ci intervals) using the same critical value of 1.96.*
...
*From the simulations that I ran using the app, 93-96% of the confidence intervals contained the true population proportion. There is some variability in these measures, such that the proportion of our confidence intervals are not always equal to the confidence level.* 

![Confidence Intervals for the Proportion of US Adults Who Think Climate Change is Affecting Their Local Communities]<img src="CI_Capture.PNG" width="600" height="300" /> 
...
*Let's select a confidence level of 99%. I would expect the confidence interval to be wider than for a 95% confidence level. This owes to the fact that our critical value is now 2.576 rather than 1.960. Our confidence interval will scale with the critical value given that it is calculated as the mean +- our critical value x our standard error. Intuitively, it makes sense that the confidence interval would increase since we account for more of the bootstrap distribution at higher confidence levels.* 
...
*Using a 99% confidence level, the calculated lower and upper bounds of the confidence interval are 0.517 and 0.817, respectively. This interval is wider than that calculated for a 95% confidence level (previously). In this instance, we are 99% confident that our confidence interval contains the population mean.* 
...
*In the first simulation trial, 100% of my confidence intervals included the true population proportion. This proportion is similar (albeit slightly greater) than my selected confidence level. 
 

<img src="CI_99.PNG" width="600" height="300" />  
...
*I will select a 90% confidence level. I expect the width of the resulting confidence interval to decrease relative to other confidence levels I have evaluated in this report. Based on the calculation below, I derive a confidence interval of 0.567-0.767. My prediction is correct.*
...
*The width of the intervals increase/decrease as the sampling size is increased/decreased, respectively.*
...
*Our confidence intervals will increase overall as we increase the number of bootstraps. This makes sense given that our equation for a standard error in bootstrapping decreases inversely to the number of bootstrap samples. *
